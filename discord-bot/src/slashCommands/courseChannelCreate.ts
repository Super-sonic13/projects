   ...
   execute: async (interaction: any) => {
      ...
      try {
         ...
         if(isPrivate && channelType === 'textchannel') {
            // const course = await axios.get("52.57.170.54:5000/api/courses").then(response => {
            ...
            const course = await axios.get(`http://52.57.170.54:5000/api/courses/${courseNameCipher}/details`, {headers}).then(response => {
               return response.data;
            })
            console.log(course)
